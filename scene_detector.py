        ...
        for i in range(0,len(filelist)):
            ...
            for e in self.extensions:
                if filelist[i].endswith(e):
                    valid=True
            if valid:
                histogram=self.getHistogram(os.path.join(self.source_path,filelist[i]))
...
if __name__ == '__main__':
    ...
    print str(args)
    es=SceneScanner(source_path=args.sequence_path,threshold=args.t,frame_distance=args.f)
